import 'package:movieflix/screen/proceedtopay.dart';
        ...
        if (value.lst.isEmpty == true) {
          return Scaffold(
              appBar: AppBar(
                ...
                centerTitle: true,
                backgroundColor: Color.fromARGB(255, 247, 142, 224),
              ),
              body: const Center(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                        primary:
                                            Color.fromARGB(255, 238, 128, 223),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Dismissible(
                            ...
                            background: Container(
                              color: Color.fromARGB(255, 241, 150, 226),
                            ),
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: Color.fromARGB(255, 242, 177, 248),
                                          ...
                                          children: [
                                            SizedBox(
                                              ...
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                  fontSize: 18,
                                                  color: Color.fromARGB(255, 238, 141, 222),
                                                ),
                                            ...
                                            Text(
                                              ...
                                              style: TextStyle(
                                                  fontSize: 14,
                                                  color: Color.fromARGB(255, 247, 151, 234)),
                                              textAlign: TextAlign.left,
                                            ),
                                          ],
                                        ),
