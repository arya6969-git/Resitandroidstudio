...
import 'package:movieflix/services/add_product.dart';
import 'package:movieflix/services/update_product_api.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (input) {
                        if (input == null || input.isEmpty) {
                          return "Please Provide Food Name";
                        } else {
                          null;
                        }
                      },
                      ...
                      decoration: InputDecoration(
                        ...
                        labelText: "Old Food Name - ${widget.name}",
                        ...
                        children: [
                          ...
                          Container(
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: Color.fromARGB(255, 240, 131, 194)),
                                borderRadius: BorderRadius.circular(3)),
                    ...
                    TextFormField(
                      ...
                      validator: (input) {
                        if (input == null || input.isEmpty) {
                          return "Please enter available Food";
                        } else {
                          null;
                        }
                      },
                      controller: stock,
                      decoration: InputDecoration(
                        labelText: "Total Available Food",
